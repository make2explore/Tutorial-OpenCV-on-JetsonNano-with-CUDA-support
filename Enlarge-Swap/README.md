...
<img src="/Enlarge-Swap/screenshots/swap4.png" width="450" height="350">  
  ...
  *This is an optional step(upgrade). If you have already upgraded system or If you do not want to make changes in current kernel and packages which comes by default with Jetpack then you can skip this step. But it is better to have system upgraded.
